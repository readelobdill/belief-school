...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract {
	 ...
	 * @var array
	 */
	protected $fillable = ['first_name', 'last_name', 'username', 'email', 'password', 'paid'];
    ...
    public function modules() {
        return $this->belongsToMany('App\Models\Module')->withTimestamps()->orderBy('order', 'asc')->withPivot(['created_at', 'updated_at', 'data', 'complete', 'step', 'completed_at', 'secret']);
    }
