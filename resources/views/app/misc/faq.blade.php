            ...
            <div class="content">
                ...
                <div class="main-copy">
                    ...
                    <ul class="faq__nav-links">
                        <li><a href="">What support will I have throughout the program?</a></li>
                        <li><a href="">I’m having trouble logging in, how do I reset my password?</a></li>
                        <li><a href="">As I work through the modules can anyone see what I write?</a></li>
                        <li><a href="">When I log in, I can’t access all of the modules, help!</a></li>
                        <li><a href="">I’m halfway through a module - what happens if I log out?</a></li>
                        <li><a href="">Can I go back to previous parts of a module that I’m currently working on?</a></li>
                        <li><a href="">Can I go back and edit previous modules that’ve already completed?</a></li>
                        <li><a href="">Can I access Forums for modules that I have completed?</a></li>
                        <li><a href="">What will I get at the end of the course?</a></li>
                        <li><a href="">Once I’m done, where to from here?</a></li>
                    </ul>
