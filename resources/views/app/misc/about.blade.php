    ...
    <div class="container about">
        <div class="inner">
            <div class="content">
                ...
                <div class="testimonials-container">
                    ...
                    <div class="content-block">
                        <div class="testimonial">
                            ...
                            <div class="quote">
                                I completed Belief School at a crossroads in my life, trying to accomplish something extremely unfamiliar, struggling with my insecurities. Belief School helped me realise how special I am, focusing me on what I wanted, that anything was possible. Each section was simple and easy to follow. By the end I felt empowered to take on any task! I truly think everybody, at any age can benefit from this awesome program. 
                            </div>
                        </div>
                        ...
                        <div class="testimonial">
                            ...
                            <div class="quote">
                                Belief school was an amazing experience for me. It challenged me to look at my thought processes, and gave me a process to create change. I would challenge any man to go through Belief Schoo. Be willing to try something new, challenge yourself in a safe environment, where you are not being criticised, or judged for attempting to figure out how you think. I found it a humbling, and VERY worthwhile experience that surprised me. I recommend EVERY man do Belief School.
                            </div>
                        </div>
                ...
                <div class="main-copy">
                    ...
                    <div class="content-block">
                        <div class="col">
                            <p>Real transformation comes from taking action. Every part of Belief School is designed to help you build belief in yourself. As you progress through the program you will see evidence of the great things that already exist in your world, your strengths, your compassion, the love and support around you.</p>
                            <blockquote>
                        ...
                        <div class="col">
                            ...
                            <p>You will start to create a picture of how you operate in the world and the greatness within you. Upon completion you will have a tool box of daily routines and processes that will have a profound effect on all aspects of your life.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="red-block">
            ...
            <div class="content-block">
                ...
                <div class="col">
                    <p><b>Supportive.</b> Do this with a group, a team, or journey alone and reach out to the Belief School community. There will ALWAYS be some to help you, recognise who you are, and give you a kick in the pants if you need it.</p>
                    <p><b>Tried and True.</b> Each of these modules have been crafted out of hundreds of hours of study and working with people one on one, we know how this goes.</p>
                </div>
            </div>
        </div>
        ...
        <div class="inner">
            <div class="content">
                ...
                <div class="main-copy">
                    ...
                    <div class="content-block">
                        <div class="col">
                            <p>Like any other program on the planet. We are pretty confident this a one of a kind.</p>
                            <p>Full of loads of theory and reading. New awareness and change can happen in an instance when we are presented with new evidence. </p>
                        </div>
                        <div class="col">
                            <p>Always easy. You can cruise through these modules not really putting in much effort and even then you will create value for yourself. Or you can be brave and play full out - this is where the gold is.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="pricing-container">
                    <h1 class="title">
                        <span data-arc="120">&middot; Pricing Details &middot;</span>
                    ...
                    <div class="content-block">
                        ...
                        <div class="what-you-get">
                            ...
                            <div class="what-you-get__node">
                                ...
                                <p><b>Eight unique, beautifully crafted modules</b>, each with an interactive exercise that is simple to complete (not always easy ☺), but doable for every single person.</p>
                            </div>
                            <div class="what-you-get__node">
                ...
                <ul class="accordion">
                    ...
                    <li>
                        ...
                        <div class="answer">
                            <p>It can be a little scary as we start to look at who we are. One of the uniquely beautiful things about Belief School is each and every module will leave you feeling good about yourself. That is our promise to you and why Paula created Belief School. Not to fix people, or to tell them to be more, to show them how special they already are.</p>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="answer">
                            <p>Some digital programs can be very dry without the human connection. We have thought about that in Belief School and have built in the community, recognition and accountability we all need to pull us towards the outcomes we want.  </p>
                        </div>
                    </li>
