    ...
    <div class="pre-complete congrats-container">
        <div class="inner">
            <div class="content">
                ...
                <p>Keep your eyes on your <a href="{{route('dashboard')}}#module-{{$module->slug}}" title="Dashboard">Dashboard</a> it is a living thing. The <a href="{{route('modules.forum',[$module->slug])}}">Forum</a> is for you, the more you give here, the more you'll get.</p>
                <div class="actions">
