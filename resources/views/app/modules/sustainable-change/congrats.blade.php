    ...
    <div class="post-complete congrats-container">
        <div class="inner">
            <div class="content">
                ...
                <p><a href="mailto:?subject=A%20request%20from%20your%20friend&body={{rawurlencode(view('emails.boomerang',['user' => Auth::user(), 'gender' => $requiredModules['home']->data->{'1'}->gender])->render() . "\n\n" . route('tagcloud', [$requiredModules['boomerang']->secret]))}}" class="button small" data-update-module>Click here to send again.</a></p>
