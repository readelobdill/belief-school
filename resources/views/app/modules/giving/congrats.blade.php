    ...
    <div class="pre-complete congrats-container">
        <div class="inner">
            <div class="content">
                ...
                <p>You'll have some lovely stories from this module, please share them in the <a href="{{route('modules.forum', $module->slug)}}">Forum</a>, they will be a gift for everyone.</p>
                <div class="actions">
