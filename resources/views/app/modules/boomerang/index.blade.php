...
@section('content')
    <div class="module boomerang-module" data-step="{{ ($moduleUser ? $moduleUser->step : 0) }}" data-is-complete="{{ ($moduleUser ? $moduleUser->complete : 0) }}" data-part="{{Input::get('part', 1)}}" data-update-url="{{route('modules.update', [$module->slug])}}" data-complete-url="{{route('modules.complete', [$module->slug])}}">
